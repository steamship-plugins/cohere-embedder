...
from api import CohereEmbedderPlugin
...
def test_embed_english_sentence():
    ...
    embedder_block_text = CohereEmbedderPlugin()
    ...
    for block in response.file.blocks:
        for tag in block.tags:
            ...
            assert len(tag.value.get(TagValue.VECTOR_VALUE)) == 2048

    embedder_tokens_text = CohereEmbedderPlugin(
        config={
